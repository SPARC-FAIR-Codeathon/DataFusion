...
#               dset = hdf5_group.create_dataset(item_name, ishape, dtype=idtype, data=item_value )
        ...
        elif len_shape ==1 and item_type(item_value[0]) == "array"  and item_value[0].dtype.type == 'numpy.unicode_': #Updated 20240811 [https://github.com/jmespath/jmespath.py/pull/188]
            if options.verbose:
